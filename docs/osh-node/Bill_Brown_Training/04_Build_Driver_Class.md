...
<div style="color:#039dfc;font-weight:bold" >Training Module 04</div>
...
<img alt="Welcome To IntelliJ Dialog Box" src="../../../static/img/IntelliJWelcomeDialog.jpeg"/>


Next, configure a new Java Project to use Gradle as the build system and select <b>Create</b>:
<img alt="IntelliJ Setup" src="../../../static/img/IntelliJSetup.png" >
...
<b>!!! MAKE SURE TO SYNC GRADLE CHANGES BY PRESSING <img src="../../../static/img/gradleRefresh.png" />  ICON IN THE TOP RIGHT OF YOUR IDE !!!</b>
...
<img alt="Create Java Class" src="../../../static/img/CreateJavaClass.png">
